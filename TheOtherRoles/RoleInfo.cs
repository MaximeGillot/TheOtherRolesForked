...
namespace TheOtherRoles
{
    public class RoleInfo {
        ...
        public static RoleInfo logger = new RoleInfo("Logger", Logger.color, "Use rigged garlics to log golems and find the Imposters", "Use trap", RoleId.Logger);
        ...
        public static RoleInfo diseased = new RoleInfo("Diseased", Color.yellow, "You are sick", "Your killer get longer kill CD", RoleId.Diseased, false, true);
